...
namespace ST10263164_MCPETRIE_PROG6212.Controllers
{
    public class HomeController : Controller
    {
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------------------------
        //--------------------------------------------------------CREATE CLAIM-------------------------------------------------------------------------------------
        //claim is created with user inputs and can be auto approved if criteria are met. If not it will be set to pending to be approved by AM and PC
        ...
        public async Task<IActionResult> CreateClaim(Models.Claim claim, IFormFile supportingDocuments) // This is the action method that will be called when the user submits the form on the CreateClaim page
        {
            ...
            else //if claim is not flagged (data for rate and hours worked is not more than in if statement) it will be automatically approved
            {
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------------------------
        //-------------------------------------------------------------ADD LECTURER--------------------------------------------------------------------------------
        // Lecturer is added to the database with user inputs
        ...
        //---------------------------------------------------------------------------------------------------------------------------------------------------------
        //-------------------------------------------------------------EDIT LECTURER-------------------------------------------------------------------------------
        //lecturer is selected by id and then the details are updated
        ...
        //--------------------------------------------------------------------------------------------------------------------------------------------
        //--------------------------------------------------------------CREATE DOC--------------------------------------------------------------------
        // pdf is autogenerated by user inputted data
